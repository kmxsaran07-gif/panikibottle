...
photologo = 'https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photoyt = 'https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photocp = 'https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png'
photozip = 'https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png'
...
image_urls = [
    "https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png",
    "https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png",
    "https://i.ibb.co/nqrF1xBF/photo-6276033000533331647-y.png",
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    photo=photologo,
                    caption="**Mʏ Nᴀᴍᴇ [DRM Wɪᴢᴀʀᴅ 🦋](https://t.me/Theprimevault01)\n\nYᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ\nCᴏɴᴛᴀᴄᴛ [Sᴘᴀʀᴋ ♨](https://t.me/Theprimevault01) ғᴏʀ ᴀᴄᴄᴇꜱꜱ**",
                    reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("Sᴘᴀʀᴋ ♨", url="https://t.me/Theprimevault01")
    ],
    [
        ...
        InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", callback_data="details")
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("Sᴘᴀʀᴋ ♨", url="https://t.me/Thekmx")
    ],
    [
        InlineKeyboardButton("ғᴇᴀᴛᴜʀᴇꜱ 🪔", callback_data="features"),
        InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", callback_data="details")
